...
namespace Unity.FPS.UI
{
    public class InGameMenuManager : MonoBehaviour
    {
        ...
        public float VolumeWhenMenuOpen = 0.2f;

        [Tooltip("Slider component for look sensitivity")]
        public Slider LookSensitivitySlider;

        [Tooltip("Sensitivity Value")]
        public TMPro.TextMeshProUGUI SensTextContent;
        ...
        void Start()
        {
            ...
            SensTextContent.text = "Sensitivity (" + LookSensitivitySlider.value + ")";
        ...
        void OnMouseSensitivityChanged(float newValue)
        {
            ...
            SensTextContent.text = "Sensitivity (" + Mathf.Round( newValue * 100f ) / 100f + ")";
        }
